...
public final class FragmentMyProductBinding implements ViewBinding {
  ...
  private FragmentMyProductBinding(@NonNull FrameLayout rootView, @NonNull ListView listview) {
  ...
  public static FragmentMyProductBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_my_product, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static FragmentMyProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMyProductBinding((FrameLayout) rootView, listview);
    }
