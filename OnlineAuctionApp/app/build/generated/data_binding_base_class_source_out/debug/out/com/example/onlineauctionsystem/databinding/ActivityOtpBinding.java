...
public final class ActivityOtpBinding implements ViewBinding {
  ...
  private ActivityOtpBinding(@NonNull ConstraintLayout rootView, @NonNull EditText email,
      @NonNull EditText otp, @NonNull TextView send, @NonNull Button verify) {
  ...
  public static ActivityOtpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOtpBinding((ConstraintLayout) rootView, email, otp, send, verify);
    }
