...
public final class ActivityProductDetailBinding implements ViewBinding {
  ...
  private ActivityProductDetailBinding(@NonNull LinearLayout rootView, @NonNull CardView cardView,
      @NonNull TextView description, @NonNull ImageView img, @NonNull TextView name,
      @NonNull Button offer, @NonNull TextView price) {
  ...
  public static ActivityProductDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.offer;
      Button offer = ViewBindings.findChildViewById(rootView, id);
      if (offer == null) {
        break missingId;
      }
      ...
      return new ActivityProductDetailBinding((LinearLayout) rootView, cardView, description, img,
          name, offer, price);
    }
