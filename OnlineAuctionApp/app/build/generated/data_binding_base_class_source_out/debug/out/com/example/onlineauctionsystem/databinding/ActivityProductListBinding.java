...
public final class ActivityProductListBinding implements ViewBinding {
  ...
  private ActivityProductListBinding(@NonNull LinearLayout rootView, @NonNull ListView listview) {
  ...
  public static ActivityProductListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityProductListBinding((LinearLayout) rootView, listview);
    }
