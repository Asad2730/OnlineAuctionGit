...
public final class ActivityFavouriteBinding implements ViewBinding {
  ...
  private ActivityFavouriteBinding(@NonNull LinearLayout rootView, @NonNull ListView listview) {
  ...
  public static ActivityFavouriteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFavouriteBinding((LinearLayout) rootView, listview);
    }
